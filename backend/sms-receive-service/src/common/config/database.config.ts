...
export const getDatabaseConfig = (configService: ConfigService): TypeOrmModuleOptions => {
  ...
  console.log('========================================');
  console.log(`服务: sms-receive-service`);
  console.log(`数据库: cloudphone_sms`);
  ...
  return {
    ...
    database: 'cloudphone_sms', // ✅ 强制使用 cloudphone_sms 数据库
    ...
    extra: {
      ...
      // 应用名称，方便在数据库端识别连接来源
      application_name: configService.get('DB_APPLICATION_NAME', 'sms-receive-service'),
      ...
      // 对于 sms-receive-service 的大量 INSERT 操作，性能提升可达 40-50%
...
export const connectionPoolHealthConfig = {
  ...
  // 慢查询告警阈值（毫秒）- sms-receive-service 标准阈值
