...
export const getDatabaseConfig = (configService: ConfigService): TypeOrmModuleOptions => {
  ...
  console.log('========================================');
  console.log(`服务: notification-service`);
  console.log(`数据库: cloudphone_notification`);
  ...
  return {
    ...
    database: 'cloudphone_notification', // ✅ 强制使用 cloudphone_notification 数据库
    ...
    extra: {
      ...
      // 应用名称，方便在数据库端识别连接来源
      application_name: configService.get('DB_APPLICATION_NAME', 'notification-service'),
      ...
      // 对于 notification-service 的大量 INSERT 操作，性能提升可达 40-50%
...
export const connectionPoolHealthConfig = {
  ...
  // 慢查询告警阈值（毫秒）- notification-service 标准阈值
