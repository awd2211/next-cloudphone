...
export const getDatabaseConfig = (configService: ConfigService): TypeOrmModuleOptions => {
  ...
  console.log('========================================');
  console.log(`服务: device-service`);
  console.log(`数据库: cloudphone_device`);
  ...
  return {
    ...
    extra: {
      ...
      // 连接参数
      // 应用名称，方便在数据库端识别连接来源
      application_name: configService.get('DB_APPLICATION_NAME', 'device-service'),
    ...
    migrationsRun: false, // 通过 Atlas 手动运行迁移
