...
describe('ReservationService', () => {
  ...
  describe('createReservation', () => {
    ...
    beforeEach(() => {
      ...
      jest
        ...
        .mockReturnValue(mockReservation as DeviceReservation);
      jest
  ...
  describe('cancelReservation', () => {
    ...
    it('should throw BadRequestException when status not cancellable', async () => {
      ...
      jest
        .spyOn(reservationRepository, 'findOne')
        .mockResolvedValue(completedReservation as DeviceReservation);
  ...
  describe('updateReservation', () => {
    ...
    it('should throw BadRequestException when status not updatable', async () => {
      ...
      jest
        .spyOn(reservationRepository, 'findOne')
        .mockResolvedValue(confirmedReservation as DeviceReservation);
  ...
  describe('getUserReservations', () => {
    ...
    it('should return paginated reservations', async () => {
      jest
        ...
        .mockResolvedValue([[mockReservation as DeviceReservation], 1]);
  ...
  describe('getReservationStatistics', () => {
    it('should return reservation statistics', async () => {
      jest
        .spyOn(reservationRepository, 'count')
  ...
  describe('Cron Jobs', () => {
    describe('executePendingReservations', () => {
      it('should execute reservations due for execution', async () => {
        ...
        jest
          ...
          .mockResolvedValue([dueReservation as DeviceReservation]);
    ...
    describe('markExpiredReservations', () => {
      it('should mark overdue reservations as expired', async () => {
        ...
        jest
          .spyOn(reservationRepository, 'find')
          .mockResolvedValue([overdueReservation as DeviceReservation]);
        jest
          .spyOn(reservationRepository, 'save')
          .mockResolvedValue(overdueReservation as DeviceReservation);
        jest.spyOn(notificationClient, 'sendBatchNotifications').mockResolvedValue(undefined);
    ...
    describe('sendReminders', () => {
      it('should send reminders for upcoming reservations', async () => {
        ...
        jest
          .spyOn(reservationRepository, 'save')
          .mockResolvedValue(upcomingReservation as DeviceReservation);
        jest.spyOn(notificationClient, 'sendBatchNotifications').mockResolvedValue(undefined);
