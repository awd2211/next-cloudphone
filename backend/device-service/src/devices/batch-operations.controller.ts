...
export class BatchOperationsController {
  ...
  async batchCreate(@Body() batchCreateDto: BatchCreateDeviceDto): Promise<BatchOperationResult> {
  ...
  async batchOperate(@Body() batchOperationDto: BatchOperationDto): Promise<BatchOperationResult> {
  ...
  async updateDeviceGroup(
    ...
    await this.batchOperationsService.updateDeviceGroup(body.deviceIds, body.groupName);
    return {
  ...
  async batchGetStatus(@Body() body: { deviceIds: string[] }): Promise<Record<string, any>> {
