...
import { INestApplication, UnauthorizedException, ConflictException, BadRequestException } from '@nestjs/common';
...
describe('AuthController', () => {
  ...
  describe('POST /auth/login', () => {
    ...
    it('should return 400 when captcha is invalid', async () => {
      // Arrange
      mockAuthService.login.mockRejectedValue(
        new BadRequestException('Invalid captcha')
      );
  ...
  describe('GET /auth/captcha', () => {
    it('should generate and return captcha image', async () => {
      ...
      const mockCaptcha = {
        id: 'captcha-uuid-123',
        image: 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==',
        expiresIn: 300,
      };
    ...
    it('should handle captcha generation errors', async () => {
      // Arrange
      mockAuthService.generateCaptcha.mockRejectedValue(
        new Error('Captcha service unavailable')
      );
