...
export const getDatabaseConfig = (configService: ConfigService): TypeOrmModuleOptions => {
  ...
  console.log('========================================');
  console.log(`服务: app-service`);
  console.log(`数据库: cloudphone_app`);
  ...
  return {
    ...
    extra: {
      ...
      // 应用名称，方便在数据库端识别连接来源
      application_name: configService.get('DB_APPLICATION_NAME', 'app-service'),
      ...
      // 对于 app-service 的 CRUD 操作，性能提升可达 30-40%
