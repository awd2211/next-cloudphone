...
PORT=30000 pnpm run dev > /home/eric/next-cloudphone/logs/api-gateway.log 2>&1 &
...
PORT=30001 pnpm run dev > /home/eric/next-cloudphone/logs/user-service.log 2>&1 &
...
PORT=30002 pnpm run dev > /home/eric/next-cloudphone/logs/device-service.log 2>&1 &
...
PORT=30003 pnpm run dev > /home/eric/next-cloudphone/logs/app-service.log 2>&1 &
...
PORT=30005 pnpm run dev > /home/eric/next-cloudphone/logs/billing-service.log 2>&1 &
...
echo "  curl http://localhost:30000/api/health"
