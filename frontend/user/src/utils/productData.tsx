 ...
 * 获取核心特性配置（支持主题 token）
 */
export const getCoreFeaturesWithToken = (token?: GlobalToken) => [
  {
    icon: <MobileOutlined style={{ fontSize: 48, color: token?.colorPrimary || '#1677ff' }} />,
    title: '真实Android环境',
    description:
  ...
  {
    icon: <CloudServerOutlined style={{ fontSize: 48, color: token?.colorSuccess || '#52c41a' }} />,
    title: '弹性云端部署',
    description:
  ...
  {
    icon: <ThunderboltOutlined style={{ fontSize: 48, color: token?.colorWarning || '#faad14' }} />,
    title: '极致性能体验',
    description:
  ...
  {
    icon: <SafetyOutlined style={{ fontSize: 48, color: token?.colorError || '#f5222d' }} />,
    title: '企业级安全',
    description:
  ...
  {
    icon: <GlobalOutlined style={{ fontSize: 48, color: token?.purple || '#722ed1' }} />,
    title: '全球节点覆盖',
    description:
  ...
  {
    icon: <ApiOutlined style={{ fontSize: 48, color: token?.cyan || '#13c2c2' }} />,
    title: '开放API接口',
    description:
 ...
 * 核心特性配置（兼容旧代码）
 */
export const coreFeatures = getCoreFeaturesWithToken();

/**
 * 获取使用场景配置（支持主题 token）
 */
export const getUseCasesWithToken = (token?: GlobalToken) => [
  {
    icon: <RocketOutlined style={{ fontSize: 32, color: token?.colorPrimary || '#1677ff' }} />,
    title: 'App自动化测试',
    description:
  ...
  {
    icon: <TeamOutlined style={{ fontSize: 32, color: token?.colorSuccess || '#52c41a' }} />,
    title: '游戏托管代练',
    description:
  ...
  {
    icon: <LineChartOutlined style={{ fontSize: 32, color: token?.colorWarning || '#faad14' }} />,
    title: '移动办公协作',
    description:
  ...
  {
    icon: <SettingOutlined style={{ fontSize: 32, color: token?.purple || '#722ed1' }} />,
    title: '应用分发测试',
    description:
 ...
 * 使用场景配置（兼容旧代码）
 */
export const useCases = getUseCasesWithToken();
